...
<div id="content">
	...
	<div id="page-heading">
		...
		<div id="in_tag">
			...
			<a href="<?php echo base_url()?>admin/coupons/all_coupons/used" <?php echo ($menu=='used'?'class="active"':'class="inactive"')?> >Used Coupons </a>
			
			<a href="<?php echo base_url()?>admin/coupons/all_coupons/active" <?php echo ($menu=='active'?'class="active"':'class="inactive"')?> >Unused Coupons </a>
			
			<a href="<?php echo base_url()?>admin/coupons/all_coupons" <?php echo ($menu==''?'class="active"':'class="inactive"')?> >All Coupons </a>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a href="">Total Coupons</a></th>
