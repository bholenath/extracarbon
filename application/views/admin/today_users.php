		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left"><a href="">Metro Card No.</a></th>
					<th class="table-header-repeat line-left"><a href="">Register Date</a></th>
				...
				?>	
						<tr>
							...
							<td><a href=""><?php echo $sch->name?></a></td>
							<td><a href="<?php echo base_url().'admin/home/details/'.$sch->id?>"><?php echo $sch->metro_card_no?></a></td>
							<td><a href=""><?php echo ($sch->date) ?></a></td>
							<td><a href=""><?php echo ($sch->metro_point + $sch->waste_pick_point) ?></a></td>
