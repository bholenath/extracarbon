...
<div id="login-holder">
	...
	<!-- start logo -->
	<div id="logo-login">
		<a href="index.html"><img src="<?php echo base_url().'assets/admin/'?>images/shared/logo.png" width="156" height="70" alt=""/>
		</a>
	</div>
	<!-- end logo -->
	<div id="entry-login">
		<a href="<?php echo base_url()?>admin/login" style="text-decoration:none; color:#fff;">Admin Login</a>
	</div>
	...
	<div id="login-inner">
		...
		<?php echo $this->session->flashdata('entry_err') ?>
		<form action="<?php echo base_url()?>admin/entry_login" method="post">
		...
		<tr>
			<th></th>
			<td valign="top"><input type="checkbox" class="checkbox-size" id="login-check" /><label for="login-check">Remember me</label>
			</td>
		</tr>
		<tr>
			<th></th>
