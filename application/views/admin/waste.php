		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a href="">Waste Item</a></th>
					<th class="table-header-repeat line-left"><a href="">Quantity Collected</a></th>
					<th class="table-header-repeat line-left"><a href="">Amount Collected</a></th>
				...
				if(isset($waste_collection) && is_array($waste_collection) && !empty($waste_collection))
				{
					foreach($waste_collection as $wa_col)
					{
				?>	
						<tr>
							<td><input  type="checkbox"/></td>
							<td>
								<a href="<?php echo base_url().'admin/home/collection_details/'.$wa_col->id?>">
									<?php echo $wa_col->item_name ?>
								</a>
							</td>

							<td><a href=""><?php echo $wa_col->waste_collected ?>&nbsp;Kg</a></td>
							<!-- <td><a href=""><?php //echo $wa_col->feriwala_name ?></a></td> -->
							<td><a href="<?php echo base_url().'admin/home/collection_details/'.$wa_col->id?>">
							<?php echo $wa_col->amount_for_waste ?>&nbsp;INR</a></td>
							...
							<td class="options-width">
								...
								<a href="<?php echo base_url().'admin/home/collection_details/'.$wa_col->id?>" title="View Details" 
								...
								<a href="<?php echo base_url().'admin/home/del_user/'.$wa_col->id?>" title="Delete" 
