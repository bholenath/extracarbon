...
<div id="content">
	...
	<div id="page-heading">
		...
		<div id="in_tag">
			...
			<a href="<?php echo base_url()?>admin/carpool/all_poolers/un" <?php echo ($menu=='un'?'class="active"':'class="inactive"')?> >Show Not Confirmed Offers </a>
			
			<a href="<?php echo base_url()?>admin/carpool/all_poolers/cn" <?php echo ($menu=='cn'?'class="active"':'class="inactive"')?> >Show Confirmed Offers </a>
			
			<a href="<?php echo base_url()?>admin/carpool/all_poolers" <?php echo ($menu==''?'class="active"':'class="inactive"')?> >All </a>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left"><a href="">Car No.</a></th>
				...
				if(is_array($carpooler) && !empty($carpooler))
				{
					foreach($carpooler as $req)
					{
				?>	
						<tr>
							...
							<td><a href=""><?php echo $req->car_rc ?></a></td>
